...
from locators.locator_main_question import  *
...
class TestMainQuestion:
    ...
    def test_main_question_0(self, driver):
        ...
        ya_question.click_question(main_question_0)
    ...
    def test_main_question_1(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_1)
    ...
    def test_main_question_2(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_2)
    ...
    def test_main_question_3(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_3)
    ...
    def test_main_question_4(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_4)
    ...
    def test_main_question_5(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_5)
    ...
    def test_main_question_6(self, driver):
        ...
        ya_question = MainPage(driver)
        ya_question.click_question(main_question_6)
